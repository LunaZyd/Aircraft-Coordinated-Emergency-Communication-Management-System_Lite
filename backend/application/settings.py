...
# Build paths inside the project like this: r / 'subdir'.
...
INSTALLED_APPS = [
    ...
    "django.contrib.contenttypes",#ORM模型关联工具
    "django.contrib.sessions",#内置会话处理器
    "django.contrib.messages",#内置消息推送框架
    "django.contrib.staticfiles",#内置静态文件处理工具
